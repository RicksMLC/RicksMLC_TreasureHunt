...
-- A fine-grained entry is a more detailed definition of a treasure map which consists of
--      { Item=itemType, BuilingOffsetX=n, BuildingOffsetY=n, Town=string, Barricades={min,max} Zombies={min,max}, VisualDecorator=string }
--
