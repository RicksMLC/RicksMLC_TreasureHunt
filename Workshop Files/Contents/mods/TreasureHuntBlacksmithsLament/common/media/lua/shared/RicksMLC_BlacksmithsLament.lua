-- RicksMLC_BlacksmithsLament.lua
-- 
...
function RicksMLC_BlacksmithsLament.GenMagDecorator(stashMap, stashX, stashY)
...
function RicksMLC_BlacksmithsLament.FluffyFootDecorator(stashMap, x, y)
...
function RicksMLC_BlacksmithsLament.MetalworkKitDecorator(stashMap, x, y)
...
function RicksMLC_BlacksmithsLament.MetalworkKitDecorator2(stashMap, x, y)
    stashMap:addStamp("Target", nil, x, y, 0, 0, 0.75)
...
local function RegisterMapDecorators()
    RicksMLC_MapDecorators.Instance():Register("MetalworkKitDecorator", RicksMLC_BlacksmithsLament.MetalworkKitDecorator)
    RicksMLC_MapDecorators.Instance():Register("MetalworkKitDecorator2", RicksMLC_BlacksmithsLament.MetalworkKitDecorator2)
...
-- Notes about the Blacksmit's Lament:
--      Recipe: "Forge_Tongs"  Learnt by reading "BSToolsSchematic". Picking up the item will trigger the random recipe.
--      Recipe: "Forge_Heading_Tool"  also in BSToolsSchematic.
--      Recipe: "Drill_Heading_Tool"  is missing from BSToolsSchematic.  Mod to append to SpecialLootSpawns.BSToolsSchematics list

RicksMLC_BlacksmithsLament.TreasureHuntDefinitions = {
    {Name = "Blacksmith's Lament", 
     Barricades = {20, 60},
     Town = "Rosewood",
     Treasures = {
        {Item = "BlowTorch", 
...
--     DebugLog.log(DebugType.Mod, "RicksMLC_BlacksmithsLament AddSampleTownToTreasureHunt()")
...
local function LoadTreasureHunts()
    RicksMLC_TreasureHuntMgr.Instance():LoadTreasureHuntDefinitions(RicksMLC_BlacksmithsLament.TreasureHuntDefinitions)
end
...
Events.RicksMLC_TreasureHuntMgr_InitDone.Add(LoadTreasureHunts)
