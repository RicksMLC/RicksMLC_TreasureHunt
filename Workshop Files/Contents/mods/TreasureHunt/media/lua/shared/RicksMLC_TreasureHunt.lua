...
function RicksMLC_TreasureHunt.setBoundsInSquares(mapAPI)
    ...
    local treasureMaps = getPlayer():getModData()["RicksMLC_TreasureHunt"]
...
function RicksMLC_TreasureHunt.InitTreasureHunt()
    local treasureHunt = getPlayer():getModData()["RicksMLC_TreasureHunt"]
    if not treasureHunt then
        RicksMLC_TreasureHunt.GenerateTreasures()
    end
    treasureHunt = getPlayer():getModData()["RicksMLC_TreasureHunt"]
    if not treasureHunt then
...
function RicksMLC_TreasureHunt.OnGameStart()
    ...
    -- Add a treasure map to the player inventory
    --local treasureHunt = getPlayer():getModData()["RicksMLC_TreasureHunt"]
...
-- FIXME: Uncomment when create player works.
