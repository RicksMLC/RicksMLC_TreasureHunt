...
RicksMLC_MapInfo.Louisville.LouisvilleMap1 = {lvGridX1(0), lvGridY1(0), lvGridX2(0), lvGridY2(0)}
RicksMLC_MapInfo.Louisville.LouisvilleMap2 = {lvGridX1(1), lvGridY1(0), lvGridX2(1), lvGridY2(0)}
RicksMLC_MapInfo.Louisville.LouisvilleMap3 = {lvGridX1(2), lvGridY1(0), lvGridX2(2), lvGridY2(0)}
RicksMLC_MapInfo.Louisville.LouisvilleMap4 = {lvGridX1(0), lvGridY1(1), lvGridX2(0), lvGridY2(1)}
RicksMLC_MapInfo.Louisville.LouisvilleMap5 = {lvGridX1(1), lvGridY1(1), lvGridX2(1), lvGridY2(1)}
RicksMLC_MapInfo.Louisville.LouisvilleMap6 = {lvGridX1(2), lvGridY1(1), lvGridX2(2), lvGridY2(1)}
RicksMLC_MapInfo.Louisville.LouisvilleMap7 = {lvGridX1(0), lvGridY1(2), lvGridX2(0), lvGridY2(2)}
RicksMLC_MapInfo.Louisville.LouisvilleMap8 = {lvGridX1(1), lvGridY1(2), lvGridX2(1), lvGridY2(2)}
RicksMLC_MapInfo.Louisville.LouisvilleMap9 = {lvGridX1(2), lvGridY1(2), lvGridX2(2), lvGridY2(2)}

RicksMLC_MapInfo.Muldraugh = {10540, 9240, 11217, 10696}
RicksMLC_MapInfo.Rosewood = {7900, 11140, 8604, 12139}
RicksMLC_MapInfo.Riverside = {6000, 5035, 6899, 5669}
RicksMLC_MapInfo.Westpoint = {10820, 6500, 12389, 7469}
RicksMLC_MapInfo.MarchRidge = {9700, 12470, 10579, 13199}
...
function RicksMLC_MapUtils.GetMapExtents(townName, mapNum)
    ...
    return {x1 = mapExtents[1], y1 = mapExtents[2], x2 = mapExtents[3], y2 = mapExtents[4]}
end
